...
By configuring your version control system to use GitHub, GitLab or Bitbucket, you’ll have **backups** of every version. Follow this [webinar for an introduction to GitHub](https://www.youtube.com/watch?v=lRW8mlpTw5M).
...
![](https://raw.githubusercontent.com/EstherPlomp/PRES-data-software/main/images/citationcff-result.jpg) See [The Turing Way](https://the-turing-way.netlify.app/communication/citable/citable-cff.html) for more information
...
#### See also this [video](https://youtu.be/6yhuHCEjPNU) (& [slides](http://doi.org/10.5281/zenodo.4706180)) with tips on Software Citation
...
> There will be an online event to contribute to the Turing Way in May/June. Contact Esther for more information.
